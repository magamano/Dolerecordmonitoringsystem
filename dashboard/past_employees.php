...
?>
	<section class="side-menu fixed left">
		...
		<ul class="nav">
			...
			<li class="nav-item"><a href="../dashboard/current_employees.php"><span class="nav-icon"><i class="fa fa-check"></i></span>Single Clients</a></li>
			<li class="nav-item current"><a href="../dashboard/past_employees.php"><span class="nav-icon"><i class="fa fa-times"></i></span>Married Clients</a></li>
	...
	<section class="contentSection right clearfix">
		<div class="container">
			<div class="wrapper employee_list clearfix">
				<div class="section_title">All Past Clients</div>
				<div class="top-bar">
					<div class="top-item">
					...
					<div id="displayempList">
						<?php
							if($getempcount >= 1 ){
								...
								echo '<li class="emp_item"> No Client record found </li>';
							}
						?>
					</div>
				</ul>
