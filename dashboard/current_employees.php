...
?>
	<section class="side-menu fixed left">
		...
		<ul class="nav">
			...
			<li class="nav-item current"><a href="../dashboard/current_employees.php"><span class="nav-icon"><i class="fa fa-check"></i></span>Single Clients</a></li>
			<li class="nav-item"><a href="../dashboard/past_employees.php"><span class="nav-icon"><i class="fa fa-times"></i></span>Married Clients</a></li>
			<?php if($usertype == "Admin"){ ?>
				<li class="nav-item"><a href="../dashboard/add_employee.php"><span class="nav-icon"><i class="fa fa-user-plus"></i></span>Add Client</a></li>
	...
	<section class="contentSection right clearfix">
		<div class="container">
			<div class="wrapper employee_list clearfix">
				<div class="section_title">All Single Clients</div>
				<div class="top-bar">
					<div class="top-item">
				...
				<ul class="emp_list">
					<li class="emp_list_head">
						<div class="emp_item_head emp_id">Client ID</div>
						<div class="emp_item_head emp_name">Name</div>
						<div class="emp_item_head">Birthday</div>
						<div class="emp_item_head">Type of Beneficiares</div>
						<div class="emp_item_head emp_status">Civil Status</div>
